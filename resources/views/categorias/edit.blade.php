            ...
            <form action="{{ route('categoria.update', $categoria->id) }}" method="post"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nombre" id="" class="form-control" placeholder="Ingrese el nombre"
                        aria-describedby="helpId" required value="{{ $categoria->nombre }}" />
                    {{-- <small id="helpId" class="text-muted">Help text</small> --}}
                </div>
                <div class="mb-3">
                    <label for="" class="form-label">Descripcion</label>
                    <textarea class="form-control" name="descripcion" id="" rows="3">{{ $categoria->descripcion }}</textarea>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select form-select-lg" name="estado" id="" required>
                        ...
                        <option value="0" {{ $categoria->estado == '0' ? 'selected' : '' }}>No activo</option>
